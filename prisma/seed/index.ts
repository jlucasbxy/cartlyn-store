    ...
    const products = await prisma.product.createMany({
        data: [
            // Seller 1 products - Electronics
            {
                ...
                price: 3499.99,
                description: 'Notebook Dell Inspiron 15 com Intel Core i5 de 11ª geração, 16GB RAM, 512GB SSD, tela Full HD de 15.6 polegadas, ideal para trabalho e estudos.',
            ...
            },
            {
                ...
                price: 149.90,
                description: 'Mouse gamer com iluminação RGB personalizável, 7 botões programáveis, DPI ajustável até 16000, sensor óptico de alta precisão.',
            ...
            },
            {
                ...
                price: 299.99,
                description: 'Teclado mecânico com switches blue, retroiluminação RGB, estrutura em alumínio, ABNT2, anti-ghosting completo.',
            ...
            },
            {
                ...
                price: 899.00,
                description: 'Monitor Full HD 27 polegadas IPS, 75Hz, FreeSync, bordas ultrafinas, ideal para produtividade e entretenimento.',
            ...
            },
            {
                name: 'Headset Gamer',
                price: 199.90,
                description: 'Headset gamer com som surround 7.1, microfone retrátil com cancelamento de ruído, almofadas em couro sintético.',
            ...
            },
            {
                name: 'Webcam Full HD',
                price: 249.99,
                description: 'Webcam 1080p 60fps com microfone integrado, autofoco, correção de luz, ideal para streaming e videoconferências.',
            ...
            },
            {
                name: 'SSD 1TB NVMe',
                price: 449.00,
                description: 'SSD M.2 NVMe 1TB, velocidade de leitura até 3500MB/s, perfeito para upgrade de desempenho.',
            ...
            },
            {
                ...
                price: 499.00,
                description: 'Mesa para computador em MDF, 120cm de largura, com suporte para monitor, gaveta para teclado, design moderno.',
                imageUrl: 'https://images.unsplash.com/photo-1595515106969-1ce29566ff1c?w=800',
                sellerId: seller2.id,
            },
            {
                name: 'Mousepad Extended',
                price: 79.90,
                description: 'Mousepad gamer tamanho estendido 90x40cm, base antiderrapante, superfície de tecido, bordas costuradas.',
            ...
            },
            {
                ...
                price: 89.90,
                description: 'Suporte ajustável para notebook até 17 polegadas, 6 níveis de altura, ventilação otimizada, alumínio premium.',
            ...
            },
            {
                ...
                price: 159.90,
                description: 'Hub USB-C com HDMI 4K, 3x USB 3.0, leitor SD/microSD, USB-C PD 100W, design compacto em alumínio.',
            ...
            },
            {
                name: 'Luminária LED',
                price: 129.00,
                description: 'Luminária LED para mesa com 3 temperaturas de cor, controle de brilho, braço articulado, base com carregador wireless.',
            ...
            },
            {
                ...
                price: 39.90,
                description: 'Kit organizador de cabos com 10 peças, prendedores magnéticos, clipes adesivos, velcro reutilizável.',
            ...
            },
            {
                ...
                price: 149.90,
                description: 'Power bank 20000mAh com carga rápida 18W, 2 portas USB, 1 USB-C, display digital, compatível com todos os dispositivos.',
